...
├── modules/              60 files, loaded by the §1.12 loader
...
```
🧭 Lees-MacBook-Air  ·  60 modules  ·  114 ⇪ shortcuts  ·  0.43s
...
Syntax on `init.lua`, `core/` and all 60 modules, sixty Lua suites, then the
