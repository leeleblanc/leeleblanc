...
├── modules/              57 files, loaded by the §1.12 loader
...
```
🧭 Lees-MacBook-Air  ·  57 modules  ·  113 ⇪ shortcuts  ·  0.43s
...
Syntax on `init.lua`, `core/` and all 57 modules, fifty-six Lua suites, then the
