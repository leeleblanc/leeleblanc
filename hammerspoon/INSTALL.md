...
├── modules/              61 files, loaded by the §1.12 loader
...
```
🧭 Lees-MacBook-Air  ·  61 modules  ·  114 ⇪ shortcuts  ·  0.43s
...
Syntax on `init.lua`, `core/` and all 61 modules, sixty-one Lua suites, then the
