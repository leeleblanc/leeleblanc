...
├── modules/              67 files, loaded by the §1.12 loader
...
```
🧭 Lees-MacBook-Air  ·  67 modules  ·  114 ⇪ shortcuts  ·  0.43s
...
Syntax on `init.lua`, `core/` and all 67 modules, sixty-seven Lua suites, then the
