...
├── modules/              66 files, loaded by the §1.12 loader
...
```
🧭 Lees-MacBook-Air  ·  66 modules  ·  114 ⇪ shortcuts  ·  0.43s
...
Syntax on `init.lua`, `core/` and all 66 modules, sixty-six Lua suites, then the
