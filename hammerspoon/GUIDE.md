...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,918 lines)
...
Sixty-four Lua suites, 6,805 checks, plus three more that run the Capture
Pad's, the screenshot editor's and unified search's page JavaScript under
`node` for a further 105 — **6,910 checks over sixty-nine stages** in
