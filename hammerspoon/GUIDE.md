...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,904 lines)
...
Sixty-seven Lua suites, 7,262 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 289 — **7,551 checks over
