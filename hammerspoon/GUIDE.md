...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,606 lines)
...
Sixty-two Lua suites, 6,123 checks, plus three more that run the Capture
Pad's, the screenshot editor's and unified search's page JavaScript under
`node` for a further 105 — **6,228 checks over sixty-seven stages** in
