...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,771 lines)
...
Sixty-eight Lua suites, 7,968 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 407 — **8,375 checks over
