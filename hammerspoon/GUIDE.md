...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,552 lines)
...
Sixty-two Lua suites, 6,025 checks, plus three more that run the Capture
Pad's, the screenshot editor's and unified search's page JavaScript under
`node` for a further 105 — **6,130 checks over sixty-seven stages** in
