...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,699 lines)
...
Sixty-eight Lua suites, 7,504 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 291 — **7,795 checks over
