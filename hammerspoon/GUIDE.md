...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,887 lines)
...
Sixty-five Lua suites, 6,827 checks, plus three more that run the Capture
Pad's, the screenshot editor's and unified search's page JavaScript under
`node` for a further 105 — **6,932 checks over seventy stages** in
