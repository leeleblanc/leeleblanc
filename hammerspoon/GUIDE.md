...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,683 lines)
...
Sixty-eight Lua suites, 7,548 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 346 — **7,894 checks over
