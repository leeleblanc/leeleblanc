...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,933 lines)
...
Sixty-six Lua suites, 6,896 checks, plus three more that run the Capture
Pad's, the screenshot editor's and unified search's page JavaScript under
`node` for a further 105 — **7,001 checks over seventy-one stages** in
