...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,892 lines)
...
Sixty-seven Lua suites, 7,069 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 161 — **7,230 checks over
