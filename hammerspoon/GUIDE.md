...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,782 lines)
...
Sixty-eight Lua suites, 7,834 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 407 — **8,241 checks over
