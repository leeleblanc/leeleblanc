...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3582 lines)
...
Seventy-two Lua suites, 8,801 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 529 — **9,332 checks over
seventy-eight stages** in
