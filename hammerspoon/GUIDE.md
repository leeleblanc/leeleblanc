...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,687 lines)
...
Sixty-eight Lua suites, 7,583 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 374 — **7,957 checks over
