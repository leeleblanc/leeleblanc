...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,729 lines)
...
Sixty-eight Lua suites, 7,975 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 407 — **8,382 checks over
