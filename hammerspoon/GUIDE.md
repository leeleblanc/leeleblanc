...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,894 lines)
...
Sixty-seven Lua suites, 7,260 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 259 — **7,519 checks over
