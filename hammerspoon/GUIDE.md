...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,739 lines)
...
Sixty-eight Lua suites, 7,719 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 400 — **8,119 checks over
