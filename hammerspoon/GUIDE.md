...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,745 lines)
...
Sixty-eight Lua suites, 7,726 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 400 — **8,129 checks over
