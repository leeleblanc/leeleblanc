...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,676 lines)
...
Sixty-eight Lua suites, 7,615 checks, plus four more that run the Capture
Pad's, the screenshot editor's, unified search's and the vault's page
JavaScript under `node` for a further 393 — **8,008 checks over
