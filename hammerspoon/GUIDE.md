...
```
~/.hammerspoon/
├── init.lua          the orchestrator (3,883 lines)
...
Sixty-five Lua suites, 6,846 checks, plus three more that run the Capture
Pad's, the screenshot editor's and unified search's page JavaScript under
`node` for a further 105 — **6,951 checks over seventy stages** in
